...
export const PostText: FC<PostItemProps> = ({ postItem, refresh = ()=>{} }) => {
    return <PostItemLayout postItem={postItem} refresh={refresh}>{postItem.content}</PostItemLayout>
}
export const PostImage: FC<PostItemProps> = ({ postItem, refresh }) => {
    return <PostItemLayout postItem={postItem} refresh={refresh}>
        <img src={getImageUrl(postItem.content)} alt="postItem" />
    </PostItemLayout>
}
...
const PostItemLayout: FC<PostItemProps> = ({ postItem, refresh = () => {}, children }) => {
    ...
    return <div className="bg-white text-black rounded">
        <div className="p-2 flex justify-between items-center border-b">
            ...
            <div className="flex gap-2">
                ...
                <button onClick={onDelete}><img src={Delete} alt="delete" className="w-6" /></button>
            </div>
        </div>
